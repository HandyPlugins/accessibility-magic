...
use function AccessibilityToolkit\Utils\get_doc_url;
use function AccessibilityToolkit\Utils\get_license_key;
use function AccessibilityToolkit\Utils\get_license_url;
use function AccessibilityToolkit\Utils\get_supported_units;
use function AccessibilityToolkit\Utils\get_ttl_with_interval;
use function AccessibilityToolkit\Utils\mask_string;
use const AccessibilityToolkit\Constants\BLOG_URL;
use const AccessibilityToolkit\Constants\DEFAULT_SETTINGS;
use const AccessibilityToolkit\Constants\DOCS_URL;
use const AccessibilityToolkit\Constants\FAQ_URL;
use const AccessibilityToolkit\Constants\GITHUB_URL;
...
use const AccessibilityToolkit\Constants\SUPPORT_URL;
use const AccessibilityToolkit\Constants\TWITTER_URL;
...
function setup() {
	if ( ACCESSIBILITY_TOOLKIT_IS_NETWORK ) {
		...
		add_filter( 'network_admin_plugin_action_links_' . plugin_basename( ACCESSIBILITY_TOOLKIT_PLUGIN_FILE ), __NAMESPACE__ . '\\plugin_action_links' );
	} else {
		add_action( 'admin_menu', __NAMESPACE__ . '\\admin_menu' );
		add_filter( 'plugin_action_links_' . plugin_basename( ACCESSIBILITY_TOOLKIT_PLUGIN_FILE ), __NAMESPACE__ . '\\plugin_action_links' );
	}
...
function plugin_action_links( $links ) {
	$settings_url = ACCESSIBILITY_TOOLKIT_IS_NETWORK
	...
	$settings_link = sprintf(
		...
		esc_html__( 'Settings', 'accessibility-toolkit' )
	);
 ...
 */
function admin_menu() {
	$parent = ACCESSIBILITY_TOOLKIT_IS_NETWORK ? 'settings.php' : 'options-general.php';

	add_submenu_page(
		$parent,
		esc_html__( 'Accessibility Toolkit', 'accessibility-toolkit' ),
		esc_html__( 'Accessibility Toolkit', 'accessibility-toolkit' ),
	...
	<main class="sui-wrap">
		<div class="sui-header">
			<h1 class="sui-header-title">
				<?php esc_html_e( 'Accessibility Toolkit', 'accessibility-toolkit' ); ?>
			</h1>
			...
			<div class="sui-actions-right">
				<a href="<?php echo esc_url( DOCS_URL ); ?>" class="sui-button sui-button-blue" target="_blank">
					...
					<?php esc_html_e( 'Documentation', 'accessibility-toolkit' ); ?>
				</a>
			</div>
		</div>

		<form method="post" action="">
			<?php wp_nonce_field( 'accessibility_toolkit_settings', 'accessibility_toolkit_settings' ); ?>
				...
				<div class="sui-box" data-tab="basic-options">
					...
					<div class="sui-box-header">
						<h2 class="sui-box-title">
							<?php esc_html_e( 'Settings', 'accessibility-toolkit' ); ?>
						</h2>
						<div class="sui-actions-right sui-hidden-important" style="display: none;">
							<button type="submit" class="sui-button sui-button-blue" id="accessibility-toolkit-save-settings-top" data-msg="">
								...
								<?php esc_html_e( 'Update settings', 'accessibility-toolkit' ); ?>
							</button>
						</div>
					</div>
					...
					<div class="sui-box-body sui-upsell-items">
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Text Size Control', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_text_size" class="sui-toggle">
										...
										<span id="enable_text_size_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable text size control. Allows to increase or decrease font size for better readability.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Text Space Control', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_text_spacing" class="sui-toggle">
										...
										<span id="enable_text_spacing_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable text space control. Allows to expand or contract space between characters and words.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Line Height Control', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_line_height" class="sui-toggle">
										...
										<span id="enable_line_height_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable line height control. Allows to adjust the vertical space between lines of text.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row sui-disabled">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Invert Colors', 'accessibility-toolkit' ); ?>
									<span class="sui-tag sui-tag-pro"><?php esc_html_e( 'Pro', 'accessibility-toolkit' ); ?></span>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_invert_colors" class="sui-toggle">
										...
										<span id="enable_invert_colors_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable invert colors. Allows to switch the document\'s background between black and white, while correspondingly inverting the default text color from black to white and vice versa.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Gray Hues', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_gray_hues" class="sui-toggle">
										...
										<span id="enable_gray_hues_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable gray hues. Allows to toggle the website\'s color scheme to grayscale, encompassing all content including images.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Underline Links', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_underline_links" class="sui-toggle">
										...
										<span id="enable_underline_links_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable underline links. Allows to underline all links within the document.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Big Cursor', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_big_cursor" class="sui-toggle">
										...
										<span id="enable_big_cursor_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable big cursor. Replace the default mouse cursor with a larger version.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Reading Guide', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_reading_guide" class="sui-toggle">
										...
										<span id="enable_reading_guide_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable reading guide. Display a guide line to assist in tracking text while reading.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row sui-disabled">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Text to Speech', 'accessibility-toolkit' ); ?>
									<span class="sui-tag sui-tag-pro"><?php esc_html_e( 'Pro', 'accessibility-toolkit' ); ?></span>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_text_to_speech" class="sui-toggle">
										...
										<span id="enable_text_to_speech_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enable the browser\'s text-to-speech function to read out text.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row sui-disabled">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Animations', 'accessibility-toolkit' ); ?>
									<span class="sui-tag sui-tag-pro"><?php esc_html_e( 'Pro', 'accessibility-toolkit' ); ?></span>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="disable_animations" class="sui-toggle">
										...
										<span id="disable_animations_label" class="sui-toggle-label">
											<?php esc_html_e( 'Add an option to disable animations.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Hotkeys', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="enable_hotkeys" class="sui-toggle">
										...
										<span id="enable_hotkeys_label" class="sui-toggle-label">
											<?php esc_html_e( 'Use keyboard shortcuts to activate/deactivate features.', 'accessibility-toolkit' ); ?>
										</span>
										<span class="sui-description">
                                            ...
                                            echo wp_kses_post(
                                                sprintf(
                                                    ...
                                                    __( 'You can find a list of key mappings in the %s.', 'accessibility-toolkit' ),
                                                    '<a href="' . esc_url( get_doc_url( '/hotkeys/' ) ) . '" target="_blank">' . esc_html__( 'documentation', 'accessibility-toolkit' ) . '</a>'
                                                )
											);
                                            ?>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Accessibility Statement', 'accessibility-toolkit' ); ?>
								</span>
							</div>
								...
								<div class="sui-form-field">
									<label for="accessibility_statement">
										...
										<span id="accessibility_statement_label" class="sui-toggle-label">
											<?php esc_html_e( 'Enter the accessibility statement URL. It opens in the iframe modal.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
								...
								<div class="sui-form-field">
									<label for="as_iframe" class="sui-toggle">
										...
										<span id="as_iframe_label" class="sui-toggle-label">
											<?php esc_html_e( 'Open accessibility statment in iframe.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
							</div>
						...
						<div class="sui-box-settings-row">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Exclusions', 'accessibility-toolkit' ); ?>
								</span>
							</div>
									...
									<div class="sui-col-md-8">
										<div class="sui-form-field">
											<label for="excluded_pages" class="sui-label">
												<?php esc_html_e( 'Do not show the accessibility toolkit on these pages', 'accessibility-toolkit' ); ?>
											</label>
											<textarea
											...
											<span id="excluded_pages_description" class="sui-description">
												<?php esc_html_e( 'The accessibility toolkit will not be added to these pages. It supports partial matching. (One per line)', 'accessibility-toolkit' ); ?>
						...
						<div class="sui-box-settings-row sui-disabled">
							<div class="sui-box-settings-col-1">
								<span class="sui-settings-label">
									<?php esc_html_e( 'Icon', 'accessibility-toolkit' ); ?>
									<span class="sui-tag sui-tag-pro"><?php esc_html_e( 'Pro', 'accessibility-toolkit' ); ?></span>
								</span>

								<span class="sui-description">
									<?php esc_html_e( 'Customize the icon appearance and position.', 'accessibility-toolkit' ); ?>
							...
							<div class="sui-box-settings-col-2">
								<div class="sui-form-field">
									<label for="icon_circular" class="sui-toggle">
										...
										<span id="icon_circular_label" class="sui-toggle-label">
											<?php esc_html_e( 'Use circular icon.', 'accessibility-toolkit' ); ?>
										</span>
									</label>
								</div>
								...
								<div class="sui-form-field">
									<fieldset id="iw_alignment">
										<span class="sui-description">
											<?php esc_html_e( 'Select icon position.', 'accessibility-toolkit' ); ?>
										</span>
										<table id="icon_position">
											<tbody>
											<tr>
												<td aria-label="<?php esc_attr_e( 'Top left', 'accessibility-toolkit' ); ?>">
													<label for="icon-position-top-left">
														<span class="screen-reader-text"><?php esc_html_e( 'Top left', 'accessibility-toolkit' ); ?></span>
														<input name="icon[position]" id="icon-position-top-left" type="radio" value="top-left" <?php checked( 'top-left', $settings['icon']['position'] ); ?>>
													</label>
												</td>
												<td aria-label="<?php esc_attr_e( 'Top right', 'accessibility-toolkit' ); ?>">
													<label for="icon-position-top-right">
														<span class="screen-reader-text"><?php esc_html_e( 'Top right', 'accessibility-toolkit' ); ?></span>
											...
											<tr>
												<td aria-label="<?php esc_attr_e( 'Bottom left', 'accessibility-toolkit' ); ?>">
													<label for="icon-position-bottom-left">
														<span class="screen-reader-text"><?php esc_html_e( 'Bottom left', 'accessibility-toolkit' ); ?></span>
												...
												<td aria-label="<?php esc_attr_e( 'Bottom right', 'accessibility-toolkit' ); ?>">
													<label for="icon-position-bottom-right">
														<span class="screen-reader-text"><?php esc_html_e( 'Bottom right', 'accessibility-toolkit' ); ?></span>
								...
								<div class="sui-form-field-row">
									<label for="background_color" class="sui-description" id="background_color-label">
										<?php esc_html_e( 'Icon Background Color:', 'accessibility-toolkit' ); ?>
									</label>
								...
								<div class="sui-form-field-row">
									...
									<label for="icon_color" class="sui-description" id="background_color-label">
										<?php esc_html_e( 'Icon Color:', 'accessibility-toolkit' ); ?>
									</label>
								...
								<div class="sui-border-frame">
									<div class="sui-form-field">
										<span class="sui-description">
											<?php esc_html_e( 'Dimension', 'accessibility-toolkit' ); ?>
										</span>

										<div class="sui-form-field-row">
											<label for="dimension_w" id="dimension_w-label">
												<?php esc_html_e( 'Width:', 'accessibility-toolkit' ); ?>
											...
											<label for="dimension_h" id="dimension_h-label">
												<?php esc_html_e( 'Height:', 'accessibility-toolkit' ); ?>
											...
											<label for="dimension-unit-selector">
												<?php esc_html_e( 'Unit', 'accessibility-toolkit' ); ?>
								...
								<div class="sui-border-frame">
									<div class="sui-form-field">
										<span class="sui-description">
											<?php esc_html_e( 'Offset', 'accessibility-toolkit' ); ?>
										</span>

										<div class="sui-form-field-row">
											<label for="offset_x" id="offset_x-label">
												<?php esc_html_e( 'X (Horizontal Offset):', 'accessibility-toolkit' ); ?>
											...
											<label for="offset_y" id="offset_y-label">
												<?php esc_html_e( 'Y (Vertical Offset):', 'accessibility-toolkit' ); ?>
						...
						<div class="sui-box-settings-row">
							<div class="sui-upsell-row">
								<div class="sui-upsell-notice">
									<p><?php esc_html_e( 'Upgrade to Accessibility Toolkit Pro to unlock advanced icon styling and advanced options.', 'accessibility-toolkit' ); ?><br>
										<a href="https://handyplugins.co/docs/accessibility-toolkit-customization/" rel="noopener" target="_blank" class="sui-button sui-button-purple" style="margin-top: 10px;color:#fff;"><?php esc_html_e( 'Try Pro today', 'accessibility-toolkit' ); ?></a>
									</p>
								</div>
							</div>
						</div>
		...
		<div class="sui-footer">
			...
			echo wp_kses_post(
				...
				/* translators: %s: HandyPlugins URL */
					__( 'Made with <i class="sui-icon-heart"></i> by <a href="%s" rel="noopener" target="_blank">HandyPlugins</a>', 'accessibility-toolkit' ),
		...
		<footer>
			...
			<ul class="sui-footer-nav">
				<li><a href="<?php echo esc_url_raw( FAQ_URL ); ?>" target="_blank"><?php esc_html_e( 'FAQ', 'accessibility-toolkit' ); ?></a></li>
				<li><a href="<?php echo esc_url( BLOG_URL ); ?>" target="_blank"><?php esc_html_e( 'Blog', 'accessibility-toolkit' ); ?></a></li>
				<li><a href="<?php echo esc_url( SUPPORT_URL ); ?>" target="_blank"><?php esc_html_e( 'Support', 'accessibility-toolkit' ); ?></a></li>
				<li><a href="<?php echo esc_url( DOCS_URL ); ?>" target="_blank"><?php esc_html_e( 'Docs', 'accessibility-toolkit' ); ?></a></li>
			</ul>

			<!-- ELEMENT: Social Media -->
			<ul class="sui-footer-social">
				<li><a href="<?php echo esc_url( GITHUB_URL ); ?>" target="_blank" aria-label="<?php esc_attr_e( 'HandyPlugins GitHub URL', 'accessibility-toolkit' ); ?>">
						<i class="sui-icon-social-github" aria-hidden="true"></i>
						<span class="sui-screen-reader-text">GitHub</span>
					</a></li>
				<li><a href="<?php echo esc_url( TWITTER_URL ); ?>" target="_blank" aria-label="<?php esc_attr_e( 'HandyPlugins Twitter URL', 'accessibility-toolkit' ); ?>">
...
function save_settings() {
	...
	$nonce = filter_input( INPUT_POST, 'accessibility_toolkit_settings', FILTER_SANITIZE_SPECIAL_CHARS );
	if ( wp_verify_nonce( $nonce, 'accessibility_toolkit_settings' ) ) {
		$settings                            = [];
		...
		add_settings_error( SETTING_OPTION, 'accessibility-toolkit', esc_html__( 'Settings saved.', 'accessibility-toolkit' ), 'success' );
	}
}
