...
if ( ! defined( 'ACCESSIBILITY_TOOLKIT_DIR' ) ) {
	define( 'ACCESSIBILITY_TOOLKIT_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'ACCESSIBILITY_TOOLKIT_PATH' ) ) {
	define( 'ACCESSIBILITY_TOOLKIT_PATH', 'path' );
}
